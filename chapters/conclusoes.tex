...
Apesar das contribuições, a pesquisa apresenta limitações relevantes que merecem ser destacadas. A amostra é relativamente pequena (n = 88), com distribuição de gênero e composição institucional que limitam a generalização dos resultados para outras regiões ou para populações maiores. Como limitações e possibilidades de trabalhos futuros, destaca-se a importância de ampliar a amostra analisada, bem como realizar a investigação em outras regiões e localidades, de modo a verificar se os padrões observados se mantêm em diferentes contextos.
