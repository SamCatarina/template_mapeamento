...
\begin{figure}[H]
    ...
    \includegraphics[width=0.9\textwidth]{images/graficos_exploratoria/grafico_gender.png}
...
Considerando a vaiável \textbf{feltSTEMNotForMeEver} Valores altos indicam que o respondente já sentiu que STEM não era para ele/ela. No gráfico, observa-se que respostas elevadas estão concentradas no gênero feminino, sugerindo que meninas apresentam maior tendência a se afastar de STEM em algum momento, reforçando questões de pertencimento e autoconfiança.
